...
\vfill
\begin{flushleft}
\hspace{2cm}\textbf{Student:} {}Lovro Bartolović{}\par
\hspace{2cm}\textbf{Studij:} {}Diplomski Sveučilišni studij računarstva{}\par
\end{flushleft}
...
\textbf{Poveznica na git repozitorij projekta:} \url{https://github.com/BartolOce/vp-eurosong-vizualizacija}
...
git clone https://github.com/BartolOce/vp-eurosong-vizualizacija.git
cd vp-eurosong-vizualizacija
...
\textbf{Demo uživo (GitHub Pages):} \url{https://bartoloce.github.io/vp-eurosong-vizualizacija/}
